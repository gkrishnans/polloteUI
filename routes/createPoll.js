...
{
  const [isShowShow,dispatch] = useReducer(reducer,isShow)
  const [isPoll,setisPoll] = useState(true)

  const isNews = useContext(isPollContext)
...
{
  const initialParams = [1:[
    image:'',
    Question:'which app is best for dream 11 prediction?',
    options:[
        [key:'a',value:'gokul\'s app',count:0],
        [key:'b',value:'Playing 11',count:0],
        [key:'c',value:'Dream 11',count:0],
        [key:'d',value:'Prediction hub',count:0],
      ],
    comments :[
        [
      user:'Gokul',
...
{
  const isNews = useContext(isPollContext)
  console.log(isNews + " from customview")
      ...
      return (  
          <View style={{flex: 1,  
            ...
            justifyContent: 'center',  }}>  
              <Text style={{flex: 1,  
            alignItems: 'center',  
            justifyContent: 'center',  }}>Switch Example</Text>  
              <Text style={{flex: 1,  
            alignItems: 'center',  
            justifyContent: 'center',  }}>{this.state.switchValue ? 'on' :'off'}</Text>  
              <Switch  
...
function HomeScreen({route,navigation}) {
  ...
  return (
      <SafeAreaView style={{flex:1}}>
        <isPollContext.Provider value = {true}>
          <Customheader title = "Home" isHome = {true} navigation = {navigation}/>
          <CustomTopTabContent  navigation = {navigation} initialParams = {route.params.tab}/>
          {console.log(isShowShow)}
          {isShowShow ? (
            <Yes navigation = {navigation} initialParams = {route.params.view} />
          ) : 
          <CustomView  navigation = {navigation} initialParams = {route.params.view} />
          }
...
function Yes({navigation,initialParams})
{
  return(
    <View style={styles.container}>
      <FlatList
            ...
            <View style={{flex: 2.5, justifyContent: 'center',  }}>  
              <View style={{flexDirection:'row',flex:1}}>
                ...
                <View style={{flexDirection:'row',flex:1,marginRight:7}}>
                  ...
                  <Switch  
                    value={isTimer}  
                    onValueChange ={(switchValue)=>setIsTimer(switchValue)}/>  
                </View>  
                </View>  
              </View> 
...
function VoteScreen({route,navigation})
{
  ...
  return(
    <View style={{flex:1,alignItem:'center',justifyContent:'center',backgroundColor:'white'}}>
        ...
        {comments && <View style={{flex:1.5,alignItem:'center',justifyContent:'center',backgroundColor:'white',marginBottom:5,marginTop:6,marginLeft:10,marginRight:10}}>
            ...
            <TouchableOpacity style={{flex:.5,alignItem:'center',justifyContent:'center',backgroundColor:'#FF69B4',marginTop:5,borderRadius:10}}
            onPress = {
              setcomments(comments)
            }
                          
            >
                <Text style={{textAlign:'center',fontFamily:'bold',color:'white',fontSize:30}}>VOTE</Text>
            </TouchableOpacity>
        </View>}
        ...
        {!comments && <View style={{flex:2,alignItem:'center',justifyContent:'center',backgroundColor:'white',marginBottom:5,marginTop:6,marginLeft:10,marginRight:10}}>
            <View style={{flex:1.5,alignItem:'center',justifyContent:'center',backgroundColor:'white',marginBottom:5}}>
