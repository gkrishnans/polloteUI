...
//  navigation.navigate('CreateScreen',{"subCategory": route.params.item.subCategory,"Category":route.params.item.Category})
      ...
      return (  
        <SafeAreaView style={{flexDirection:'column',flex:1}}>
            ...
            <View style={{height:20, justifyContent: 'center',marginLeft:23,marginBottom:20}}>  
              <Text style={{color:'gray',fontSize:17}}>Create a Poll</Text>
            </View>  


            <View style={{height:70, justifyContent: 'center',marginLeft:23}}>  
            ...
            <View style={{height:70, justifyContent: 'center',marginLeft:23,marginTop:10}}>  
            ...
            <View style={{height:250,justifyContent: 'center',  }}>  
              ...
              <View style={{height:174,marginLeft:10,marginRight:5,}}>  
              ...
              {/*list view here template in next next */}
            ...
            <View style={{height:70, justifyContent: 'center' }}>  
              ...
              <View style={{height:10,marginLeft:23,}}>  
