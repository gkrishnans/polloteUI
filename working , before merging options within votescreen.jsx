...
import { Text,TextInput, View ,SafeAreaView ,VirtualizedList,StyleSheet ,Image ,Button ,Pressable,Modal,ScrollView ,TouchableOpacity ,TouchableWithoutFeedback,Switch,Alert,ToastAndroid} from 'react-native';
...
function VoteScreen({route,navigation})
{
  ...
  return(
    <SafeAreaProvider style={{flex:1,alignItem:'center',justifyContent:'center',backgroundColor:'white'}}>
       ...
       {vote && <View style={{flex:2.5,alignItem:'center',justifyContent:'center',backgroundColor:'white',marginBottom:5,marginTop:6}}>
            <View style={{flex:1,paddingRight:10,paddingTop:10,backgroundColor:'white',marginBottom:5}}>
        ...
        <SafeAreaView style={{flexDirection:'column',flex:1,}}>
          ...
          <ScrollView>
            <View style={{flexDirection:'row',padding:3}}>
                <TouchableOpacity style={{flex: 1, justifyContent: 'center', marginLeft:7 }}
                ...
                <View style={{flex: 1,justifyContent:'center',flexDirection:'row-reverse',marginRight:10}}>  
                  
                  <TouchableOpacity style={{height:45,flex:3,backgroundColor:'#FF69B4',borderRadius:20,alignItems:'center',justifyContent:'center'}}>
